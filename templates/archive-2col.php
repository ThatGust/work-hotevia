<?php
/**
 * Template Name: Archive - 2 Col with sidebar
 *
		...
		if ( $category ) :
			...
			if ( $custom_query->have_posts() ) { ?>
                ...
                while ( $custom_query->have_posts() ) :
					...
					?>
					<article<?php printf( '%s', $schema['container'] ); ?> id="post-<?php the_ID();?>" <?php post_class( $classes . $fclass . $lclass . $ad_class ); ?>>
                    <?php
	                    if ( $ad_class ) {
